...
server <- function(input, output, session) {
  ...
  observeEvent(input$runAnalysis, {
    ...
    #df_temp <- data.frame(
    #  name = c("Location 1", "Location 2", "Location 3", "Location 4", "Location 5"),
    #  x = c(-122.4194, -74.0060, -118.2437, -0.1278, 151.2093),  # Sample longitude values
    #  y = c(37.7749, 40.7128, 34.0522, 51.5074, -33.8688)       # Sample latitude values
    #)
